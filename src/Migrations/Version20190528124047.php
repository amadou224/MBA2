 ...
 */
final class Version20190528124047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lieux (id INT AUTO_INCREMENT NOT NULL, lieux VARCHAR(150) NOT NULL, annexe TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
