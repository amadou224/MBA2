...
// Returns the private 'App\Repository\LieuDeDepartRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LieuDeDepartRepository.php';

return $this->privates['App\Repository\LieuDeDepartRepository'] = new \App\Repository\LieuDeDepartRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
