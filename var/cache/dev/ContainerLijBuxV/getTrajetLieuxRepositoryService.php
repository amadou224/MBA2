...
// Returns the private 'App\Repository\TrajetLieuxRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrajetLieuxRepository.php';

return $this->privates['App\Repository\TrajetLieuxRepository'] = new \App\Repository\TrajetLieuxRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
