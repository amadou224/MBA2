...
class __TwigTemplate_12bb74b0bfe08fc707af3b1b2f443b9e16de1d3630cdf974f5528f7101d68431 extends \Twig\Template
{
    private $source;
...
<div class=\"container mt-2\">
    <h1 class=\"text-center\">Bonjour ";
        // line 21
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 21, $this->source); })()), "nom", []), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 21, $this->source); })()), "prenom", []), "html", null, true);
        echo "</h1>
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 38, $this->source); })()), "reservations", []));
...
";
    ...
    {
        return array (  184 => 53,  171 => 46,  167 => 45,  163 => 44,  159 => 43,  155 => 42,  151 => 41,  147 => 40,  144 => 39,  140 => 38,  118 => 21,  111 => 16,  102 => 15,  91 => 12,  82 => 11,  67 => 4,  58 => 3,  27 => 1,);
    }
...
<div class=\"container mt-2\">
    <h1 class=\"text-center\">Bonjour {{ user.nom }} {{ user.prenom }}</h1>
    <h3 class=\"text-center\">Voici votre liste de réservations</h3>
    ...
    <table class=\"table\">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ reservation.departDestination.depart }}</td>
...
{% endblock %}", "profile/profile.html.twig", "C:\\wamp64\\www\\Symfony\\templates\\profile\\profile.html.twig");
    }
}
